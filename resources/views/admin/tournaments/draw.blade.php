...
<div class="tournament-draw" id="printable-area">
    <div class="no-print text-center mb-4">
        ...
        <a href="{{ route('admin.tournaments.show', $tournament->id) }}" class="btn-secondary btn-lg ml-2">
            <i class="fas fa-arrow-left"></i> Назад к турниру
        </a>
    </div>
    ...
    @else
        <div class="alert alert-info">
            ...
            <p>Для этого турнира пока нет жеребьевки. Проведите жеребьевку в административной панели.</p>
        </div>
    @endif
</div>
@endsection